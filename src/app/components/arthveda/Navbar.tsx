        ...
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative">
              ...
              <div className="relative w-10 h-10 bg-gradient-to-br from-indigo-100 to-blue-100 rounded-xl flex items-center justify-center border border-indigo-400/20 group-hover:scale-110 transition-transform">
                <img
                  src="/applogo.png"
                  alt="Zoho Logo"
            ...
            <div className="hidden sm:block">
              <div className="text-xl font-bold text-white">Arthaveda</div>
